						...
						<div class="autNewsCt row">
							<div class="top-box-article"> 
								...
								<div class="icon-list-btn col-lg-4">
									<ul class="list-tool">
										<li> 
											<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http://tuoitre.vn/tin/chinh-tri-xa-hoi/thoi-su-suy-nghi/20150103/nhung-con-so-am-anh/694194.html&amp;display=popup&amp;ref=plugin" title="Facebook">
												<img class="icon-faces" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/transparent.png">
											</a>
										</li>
										<li> 
											<a target="_blank" href="https://plus.google.com/share?url=http://tuoitre.vn/tin/chinh-tri-xa-hoi/thoi-su-suy-nghi/20150103/nhung-con-so-am-anh/694194.html" title="google plus">
							...
							<div class="bottom-box-article">
								...
								<div class="imgArtCtDetail"> 
									<em>
										<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/photo_item4.jpg" alt="8 lỗi lầm của phụ nữ khi yêu">
									</em>
								</div>
							</div>
							<div class="bottom-box-article">
					...
					<div class="like-share-con">
						...
						<div class="like_share" style="width: 100%;float: left; margin-bottom: 55px; border: 1px solid #ddd;padding: 5px;">
                        	...
                        	<div class="share" style="text-align:right; width:100%;"> 
                            		...
                            		<a rel="nofollow" target="_blank" href="http://www.facebook.com/sharer.php?u=http://blog.zotadi.com/2014/11/06/10-dat-nuoc-co-nhieu-gai-xinh-nhat-the-gioi/">
